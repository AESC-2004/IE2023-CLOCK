	...
	REVISAR_CONFIGURACION:
		...
		CONFIGURAR_MINUTOS_DE_TIME_DISPLAY:
			...
			INCREMENTAR_MINUTOS_EN_TIME_DISPLAY:
				...
				CALL	INCREMENTAR_MINUTOS
				;Revisamos si MINUTOS_DECENAS=6. Si sí, reiniciamos MINUTOS a 0. Si no, vamos al CUARTO PASO.
				LDS		R16, MINUTOS_DECENAS
				CPI		R16, 6
				BREQ	REINICIAR_MINUTOS
			...
			DECREMENTAR_MINUTOS_EN_TIME_DISPLAY:
				;Llamamos a la rutina DECREMENTAR_MINUTOS
		...
		CONFIGURAR_HORAS_DE_TIME_DISPLAY:
			...
			INCREMENTAR_HORAS_EN_TIME_DISPLAY:
				...
				CALL	INCREMENTAR_HORAS
				;Revisamos si HORAS=24. Si sí, reiniciamos HORAS a 0. Si no, vamos al CUARTO PASO.
				LDS		R16, HORAS_UNIDADES
				LDS		R17, HORAS_DECENAS
				LDI		R18, 10
				MUL		R17, R18
			...
			DECREMENTAR_HORAS_EN_TIME_DISPLAY:
				;Llamamos a la rutina DECREMENTAR_HORAS
		...
		CONFIGURAR_MES_DE_DATE_DISPLAY:
			...
			INCREMENTAR_MESES_EN_DATE_DISPLAY:
				...
				CALL	INCREMENTAR_MESES
				;Revisamos si MESES=13. Si sí, reiniciamos MESES a 01. Si no, vamos al CUARTO PASO.
				LDS		R16, MESES_UNIDADES
				LDS		R17, MESES_DECENAS
				LDI		R18, 10
				MUL		R17, R18
				...
				REINICIAR_MESES:
					...
					STS		MESES_DECENAS, R16
					RJMP	SALIR_DE_INCREMENTAR_O_DECREMENTAR_MESES_EN_DATE_DISPLAY
			DECREMENTAR_MESES_EN_TIME_DISPLAY:
				;Llamamos a la rutina DECREMENTAR_MESES
...
DECREMENTAR_MINUTOS:
	...
	DEC		R16
	CPI		R16, 0xFF
	BREQ	ESTABLECER_MINUTOS_UNIDADES_Y_DECREMENTAR_MINUTOS_DECENAS
	;Si MINUTOS_UNIDADES!=0xFF, solo lo guardamos...
	STS		MINUTOS_UNIDADES, R16
	RJMP	SALIR_DE_DECREMENTAR_MINUTOS
	ESTABLECER_MINUTOS_UNIDADES_Y_DECREMENTAR_MINUTOS_DECENAS:
		LDI		R16, 9
		STS		MINUTOS_UNIDADES, R16
		LDS		R16, MINUTOS_DECENAS
		DEC		R16
...
DECREMENTAR_HORAS:
	...
	;Si HHORAS_DECENAS=0xFF, , establecemos HORAS=23
	LDS		R16, HORAS_UNIDADES
	DEC		R16
	CPI		R16, 0xFF
	BREQ	ESTABLECER_HORAS_UNIDADES_Y_DECREMENTAR_HORAS_DECENAS
	;Si HORAS_UNIDADES!=0xFF, solo lo guardamos...
	STS		HORAS_UNIDADES, R16
	RJMP	SALIR_DE_DECREMENTAR_HORAS
	ESTABLECER_HORAS_UNIDADES_Y_DECREMENTAR_HORAS_DECENAS:
		LDI		R16, 9
		STS		HORAS_UNIDADES, R16
		LDS		R16, HORAS_DECENAS
		DEC		R16
		;Si HORAS_DECENAS=0xFF, establecemos HORAS=23
		CPI		R16, 0xFF
		BREQ	ESTABLECER_HORAS
		;Si HORAS_DECENAS!=0xFF, solo lo guardamos...
		STS		HORAS_DECENAS, R16
		RJMP	SALIR_DE_DECREMENTAR_HORAS
		ESTABLECER_HORAS:
			LDI		R16, 3
...
INCREMENTAR_MESES:
	...
	STS		MESES_UNIDADES, R16
	RJMP	SALIR_DE_INCREMENTAR_MESES
	REINICIAR_MESES_UNIDADES_E_INCREMENTAR_MESES_DECENAS:
		...
		STS		MESES_DECENAS, R16
		RJMP	SALIR_DE_INCREMENTAR_MESES
	SALIR_DE_INCREMENTAR_MESES:
		RET

DECREMENTAR_MESES:
	;¡Teniendo cuidado de establecer MESES_UNIDADES=9 y decrementar MESES_DECENAS de ser necesario!
	;Si MESES=0, , establecemos MESES=12 y re-colocamos YPointer
	;Decrementamos YPointer
	SBIW	Y, 1
	LDS		R16, MESES_UNIDADES
	DEC		R16
	;Si MESES=00, establecemos MESES=12
	LDS		R17, MESES_DECENAS
	ADD		R17, R16
	BREQ	ESTABLECER_MESES
	;Si MESES_UNIDADES=0xFF
	CPI		R16, 0xFF
	BREQ	ESTABLECER_MESES_UNIDADES_Y_DECREMENTAR_MESES_DECENAS
	;Si MESES_UNIDADES!=0xFF Y MESES!=0, solo lo guardamos...
	STS		MESES_UNIDADES, R16
	RJMP	SALIR_DE_DECREMENTAR_MESES
	ESTABLECER_MESES:
		LDI		R16, 2
		STS		MESES_UNIDADES, R16
		LDI		R16, 1
		...
		ADIW	Y, 11
		RJMP	SALIR_DE_DECREMENTAR_MESES
	ESTABLECER_MESES_UNIDADES_Y_DECREMENTAR_MESES_DECENAS:
		LDI		R16, 9
		STS		MESES_UNIDADES, R16
		LDS		R16, MESES_DECENAS
		DEC		R16
		RJMP	SALIR_DE_DECREMENTAR_MESES
	SALIR_DE_DECREMENTAR_MESES:
		RET
;***************************************************************************************************************************
